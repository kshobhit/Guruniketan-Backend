$(function(){
    ...
    var base_url='http://localhost/codeigniter/'; // Here i define the base_url
    ...
    $('#calendar').fullCalendar({
        ...
        events: base_url+'index.php/calendar/getEvents',
        ...
        dayClick: function(date, event, view) {
         ...
         eventDrop: function(event, delta, revertFunc) {  
               ...
               $.post(base_url+'index.php/calendar/dragUpdateEvent',{                            
                id:event.id,
