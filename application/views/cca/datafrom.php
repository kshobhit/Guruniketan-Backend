...
<body>
	<form method="POST" name="customerData" action="<?php echo base_url('index.php/RequestHandler/reqhandler'); ?>">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="50%" height="100" border='1' align="center">
				...
				<tr>
					<td>Merchant Id	:</td><td><input type="text" name="merchant_id" value="121336"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="http://localhost/index.php/ccavResponseHandler.php"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="http://localhost/index.php/ccavResponseHandler.php"/></td>
			 	</tr>
			 	<tr>
...
<script type="text/javascript">
  $(function(){
	 ...
	 */	  
  	  var jsonData;
  	  var access_code="AVTI68EA79BH53ITHB" // shared by CCAVENUE 
	  var amount="6000.00";
  	  var currency="INR";
