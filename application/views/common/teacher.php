  ...
  <div class="signup">
    ...
    <!--    <div class="form-group">
        <label for="dob">Date of Birth:</label>
                <input type="text" class="datepicker" placeholder="dd/mm/yyyy" data-date-format="dd/mm/yyyy">
  ...
  -->           
     <div class="input-group form-group">
      ...
      <span class="input-group-addon" id="basic-addon1"><i style="color:black;" class="fa fa-calendar"></i></span>
        <input type="text" class="datepicker" aria-describedby="basic-addon1"  data-date-format="dd/mm/yyyy">
      </div>  
