...
<div class="page-wrapper"> 
  <div class="signup">
    ...
    <hr style="border:1px solid rgba(255,152,0 ,1); width: 90%;">
      ...
      echo form_open('validate/student_edit_profile/'.$data->reg_id);?>
       ...
       <br>
       <input type="checkbox" name="newsletter"> Send me careers related news and information from guruniketan.com partners
       <br>
       ...
       <br>
        ...
        <div class="container">
        <div class="col-md-3">
           <input type="checkbox" name="board"> ICSE
        </div>
        <div class="col-md-3">   
           <input type="checkbox" name="board"> CBSE
        </div>
