...
Class Facebook
{
     ...
     * @return  string
     */
    public function login_url_teacher(){
        ...
        return $this->helper->getLoginUrl(
            base_url() . $this->config->item('facebook_login_redirect_url_teacher'),
            $this->config->item('facebook_permissions')
        );
    }
    public function login_url_student(){
        // Login type must be web, else return empty string
        if($this->config->item('facebook_login_type') != 'web'){
            return '';
        }
        // Get login url
        return $this->helper->getLoginUrl(
            base_url() . $this->config->item('facebook_login_redirect_url_student'),
            $this->config->item('facebook_permissions')
        );
    }
    /**
