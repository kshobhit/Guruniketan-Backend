...
$config['redirect_url_teacher']= "http://localhost/codeigniter/index.php/google_authentication/teacher/";
$config['redirect_url_student']= "http://localhost/codeigniter/index.php/google_authentication/student/";
?>